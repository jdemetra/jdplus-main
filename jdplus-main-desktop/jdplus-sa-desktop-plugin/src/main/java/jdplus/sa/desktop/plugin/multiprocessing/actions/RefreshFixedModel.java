...
@ActionID(category = "SaProcessing", id = RefreshFixedModel.ID)
...
public final class RefreshFixedModel extends ActiveViewAction<SaBatchUI> {
    ...
    @ClassNameConstant
    public static final String ID = "jdplus.sa.desktop.plugin.multiprocessing.actions.RefreshFixedModel";
