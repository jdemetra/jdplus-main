...
@ActionID(category = "SaProcessing", id = RefreshConcurrent.ID)
...
public final class RefreshConcurrent extends ActiveViewAction<SaBatchUI> {
    ...
    @ClassNameConstant
    public static final String ID = "jdplus.sa.desktop.plugin.multiprocessing.actions.RefreshConcurrent";
