...
@ActionID(category = "SaProcessing", id = LocalRefreshParameters.ID)
...
public final class LocalRefreshParameters extends ActiveViewAction<SaBatchUI> {
    ...
    @ClassNameConstant
    public static final String ID = "jdplus.sa.desktop.plugin.multiprocessing.actions.LocalRefreshParameters";
