...
@ActionID(category = "SaProcessing", id = LocalRefreshMovingAverageParameters.ID)
...
public final class LocalRefreshMovingAverageParameters extends ActiveViewAction<SaBatchUI> {
    ...
    @ClassNameConstant
    public static final String ID = "jdplus.sa.desktop.plugin.multiprocessing.actions.LocalRefreshMovingAverageParameters";
