 ...
 * @author Jean Palate
 */
public class HtmlResidualSeasonalityDiagnostics extends AbstractHtmlElement implements HtmlElement {

    private final ResidualSeasonalityTests tests;
    private final boolean noSeasControl;

    public HtmlResidualSeasonalityDiagnostics(final ResidualSeasonalityTests tests) {
        this(tests, false);
    }

    public HtmlResidualSeasonalityDiagnostics(final ResidualSeasonalityTests tests, final boolean noSeasControl) {
        this.tests = tests;
