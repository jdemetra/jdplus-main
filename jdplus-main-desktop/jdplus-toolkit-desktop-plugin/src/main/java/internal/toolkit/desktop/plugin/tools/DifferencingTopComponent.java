 ...
 */
package internal.toolkit.desktop.plugin.tools;

import jdplus.toolkit.base.api.data.DoubleSeq;
import jdplus.toolkit.desktop.plugin.components.JTsGrid;
import jdplus.toolkit.desktop.plugin.components.JTsGrid.Mode;
...
public final class DifferencingTopComponent extends TopComponent  implements HasTs, ExplorerManager.Provider {
    ...
    @ClassNameConstant
    public static final String ID = "internal.toolkit.desktop.plugin.tools.DifferencingTopComponent";
