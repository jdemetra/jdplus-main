...
import jdplus.toolkit.desktop.plugin.components.tools.TukeySpectrumView;
...
public final class TukeySpectrumTopComponent extends TopComponent implements HasTs, ExplorerManager.Provider {
    ...
    @ClassNameConstant
    public static final String ID = "internal.toolkit.desktop.plugin.tools.TukeySpectrumTopComponent";
