...
import static jdplus.toolkit.desktop.plugin.components.JTsGrid.*;
import static jdplus.toolkit.desktop.plugin.components.JTsGrid.Chronology.ASCENDING;
import static jdplus.toolkit.desktop.plugin.components.JTsGrid.Chronology.DESCENDING;
import static jdplus.toolkit.desktop.plugin.components.JTsGrid.Mode.MULTIPLETS;
import static jdplus.toolkit.desktop.plugin.components.JTsGrid.Mode.SINGLETS;
import static jdplus.toolkit.desktop.plugin.components.JTsGrid.Orientation.NORMAL;
import static jdplus.toolkit.desktop.plugin.components.JTsGrid.Orientation.REVERSED;
