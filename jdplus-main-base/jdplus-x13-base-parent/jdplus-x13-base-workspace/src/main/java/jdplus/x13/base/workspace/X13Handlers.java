...
public class X13Handlers {
    ...
    public static final class SaDocX13 implements FamilyHandler {
        ...
        private final FamilyHandler delegate = informationSet(
                SA_DOC_X13,
    ...
    public static final class SaSpecX13Legacy implements FamilyHandler {
        ...
        @lombok.experimental.Delegate
        private final FamilyHandler delegate =
                informationSet(SA_SPEC_X13, X13SpecMapping.SERIALIZER_LEGACY, X13SPEC_REPO);
    }
    ...
    public static final class ModSpecRegarima implements FamilyHandler {
        ...
        @lombok.experimental.Delegate
        private final FamilyHandler delegate =
                informationSet(MOD_SPEC_REGARIMA, RegArimaSpecMapping.SERIALIZER_V3, REGARIMASPEC_REPO);
    }
    ...
    public static final class ModSpecRegarimaLegacy implements FamilyHandler {
        ...
        @lombok.experimental.Delegate
        private final FamilyHandler delegate =
                informationSet(MOD_SPEC_REGARIMA, RegArimaSpecMapping.SERIALIZER_LEGACY, REGARIMASPEC_REPO);
    }
}
