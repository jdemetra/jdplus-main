...
public class X13RevisionHistory {
    ...
    public static class Revisions {
        ...
        RevisionHistory<X13Results> revisions;
        
        public TsDomain referenceDomain(){
            return revisions.getReferenceDomain();
        }
        
        public X13Results result(String period){
        ...
        public Matrix tsSelect(String id, String start, String end, String type) {
            ...
            return table.toMatrix(TsDataTable.DistributionType.valueOf(type));
        }
    ...
    public Revisions revisions(TsData series, X13Spec spec, ModellingContext context) {
