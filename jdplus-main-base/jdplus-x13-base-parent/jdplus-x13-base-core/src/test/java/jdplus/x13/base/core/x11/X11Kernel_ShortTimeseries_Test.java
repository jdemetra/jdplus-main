...
// <editor-fold defaultstate="collapsed" desc="necessary methods">
    private void testKernel(String modeName, String[] seasonalFilterOptionName, int filterLength, int frequency, double[] values) {
        ...
        X11Results x11Results = instanceKernel.process(
                jdplus.toolkit.base.api.timeseries.TsData.of(TsPeriod.of(TsUnit.ofAnnualFrequency(frequency), LocalDate.of(1900, Month.JANUARY, 1)),
        ...
        assertArrayEquals(expected_C13, actual_C13, DELTA, "Error in D1");
