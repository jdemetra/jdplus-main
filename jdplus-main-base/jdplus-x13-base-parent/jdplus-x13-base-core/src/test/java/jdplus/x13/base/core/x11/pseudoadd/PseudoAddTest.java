...
// <editor-fold defaultstate="collapsed" desc="Parameters">
    ...
    public void initPseudoAddTest(int frequency, String seasonalFilter, int filterLength, String calenderSigma, double[] series) {
...
// </editor-fold>
    ...
    @MethodSource("data")
    @ParameterizedTest(name = "{index}: Frequency {0}, seasonal filter {1}, Henderson {2}, Calendar sigma {3}, Series {4} ")
    public void test(int frequency, String seasonalFilter, int filterLength, String calenderSigma, double[] series) {
        initPseudoAddTest(frequency, seasonalFilter, filterLength, calenderSigma, series);
...
// <editor-fold defaultstate="collapsed" desc="Kernel methods">
    ...
    private void testX11Kernel(String modeName, String seasonalFilterOptionName, int filterLength, int frequency, double[] values, String calendarSigma, int forecastHorizon) {
        ...
        assertArrayEquals(expected_B3, actual_B3, DELTA, "Error in B3");
        ...
        assertArrayEquals(expected_B8, actual_B8, DELTA, "Error in B8");
        ...
        assertArrayEquals(expected_B10, actual_B10, DELTA, "Error in B10");
        ...
        assertArrayEquals(expected_B11, actual_B11, DELTA, "Error in B11");
        ...
        assertArrayEquals(expected_B13, actual_B13, DELTA, "Error in B13");
        ...
        assertArrayEquals(expected_B20, actual_B20, DELTA, "Error in B20");
        ...
        assertArrayEquals(expected_C1, actual_C1, DELTA, "Error in C1");
        ...
        assertArrayEquals(expected_C2, actual_C2, DELTA, "Error in C2");
        ...
        assertArrayEquals(expected_C5, actual_C5, DELTA, "Error in C5");
        ...
        assertArrayEquals(expected_C6, actual_C6, DELTA, "Error in C6");
        ...
        assertArrayEquals(expected_C10, actual_C10, DELTA, "Error in C10");
        ...
        assertArrayEquals(expected_C17, actual_C17, DELTA, "Error in C17");
        ...
        assertArrayEquals(expected_C20, actual_C20, DELTA, "Error in C20");
