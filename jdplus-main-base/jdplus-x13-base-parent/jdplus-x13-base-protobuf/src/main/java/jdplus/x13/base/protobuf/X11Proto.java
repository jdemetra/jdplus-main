...
public class X11Proto {
    public void fill(jdplus.x13.base.api.x11.X11Spec spec, X11Spec.Builder builder) {
        builder
    ...
    public X11Spec convert(jdplus.x13.base.api.x11.X11Spec spec) {
        X11Spec.Builder builder = X11Spec.newBuilder();
        fill(spec, builder);
        return builder.build();
    }

    public jdplus.x13.base.api.x11.X11Spec convert(X11Spec x11) {
        jdplus.x13.base.api.x11.X11Spec.Builder builder = jdplus.x13.base.api.x11.X11Spec.builder()
