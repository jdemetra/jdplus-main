...
public interface X11SpecOrBuilder extends
   ...
   */
  java.util.List<jdplus.x13.base.protobuf.SeasonalFilter> getSfiltersList();
  /**
   * <code>repeated .x13.SeasonalFilter sfilters = 4;</code>
   ...
   */
  jdplus.x13.base.protobuf.SeasonalFilter getSfilters(int index);
  /**
   * <code>repeated .x13.SeasonalFilter sfilters = 4;</code>
   ...
   * @return The sigma.
   */
  jdplus.x13.base.protobuf.CalendarSigma getSigma();
   ...
   * @return The bias.
   */
  jdplus.x13.base.protobuf.BiasCorrection getBias();
}
