...
public class RegressionDictionaries {
    ...
    public final Dictionary BASIC = AtomicDictionary.builder()
            .name("basic")
            .item(AtomicDictionary.Item.builder().name(PERIOD).description("number of observations per year").outputClass(Integer.class).build())
            .item(AtomicDictionary.Item.builder().name(SPAN_START).description("start date of SA estimation ").outputClass(TsPeriod.class).build())
            .item(AtomicDictionary.Item.builder().name(SPAN_END).description("end date of SA estimation").outputClass(TsPeriod.class).build())
            .item(AtomicDictionary.Item.builder().name(SPAN_N).description("number of observations in the original series").outputClass(Integer.class).build())
            .item(AtomicDictionary.Item.builder().name(SPAN_MISSING).description("number of missing values in the original series").outputClass(Integer.class).build())
            .item(AtomicDictionary.Item.builder().name(LOG).description("log transformation (1=Yes, 0=No)").outputClass(Integer.class).build())
            .item(AtomicDictionary.Item.builder().name(ADJUST).description("ex-ante correction for leap year, available if log-transformation").outputClass(String.class).build())
            .build();
    ...
    public final Dictionary REGRESSION_DESC = AtomicDictionary.builder()
            .name("regression")
            .item(AtomicDictionary.Item.builder().name(ESPAN_START).description("start date of pre-processing model estimation").outputClass(Integer.class).build())
            .item(AtomicDictionary.Item.builder().name(ESPAN_END).description("end date of pre-processing model estimation").outputClass(Integer.class).build())
            .item(AtomicDictionary.Item.builder().name(ESPAN_N).description("number of observations in pre-processing model estimation").outputClass(Integer.class).build())
            .item(AtomicDictionary.Item.builder().name(ESPAN_MISSING).description("number of missing values in series used for pre-processing model estimation").outputClass(Integer.class).build())
            ...
            .item(AtomicDictionary.Item.builder().name(NMH).description("number of moving holidays regressors").outputClass(Integer.class).build())
    ...
    public final Dictionary REGRESSION_EFFECTS = AtomicDictionary.builder()
            ...
            .item(AtomicDictionary.Item.builder().name(DET).description("all deterministic effects (including pre-adjustment, but without trend polynomial effect). Untransformed").outputClass(TsData.class).build())
            .item(AtomicDictionary.Item.builder().name(DET_F).description("forecasts of all deterministic effects (including pre-adjustment, but without trend polynomial effect). Untransformed").outputClass(TsData.class).type(Dictionary.EntryType.Parametric).build())
            .item(AtomicDictionary.Item.builder().name(DET_B).description("backcasts of all deterministic effects (including pre-adjustment, but without trend polynomial effect). Untransformed").outputClass(TsData.class).type(Dictionary.EntryType.Parametric).build())
            ...
            .item(AtomicDictionary.Item.builder().name(OMHE_F).description("forecasts of the other moving holidays effects. Untransformed").outputClass(TsData.class).type(Dictionary.EntryType.Parametric).build())
            .item(AtomicDictionary.Item.builder().name(OMHE_B).description("backcasts of the other moving holidays effects. Untransformed").outputClass(TsData.class).type(Dictionary.EntryType.Parametric).build())
