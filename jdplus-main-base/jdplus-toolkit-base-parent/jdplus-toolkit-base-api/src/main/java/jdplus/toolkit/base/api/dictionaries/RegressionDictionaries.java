...
public class RegressionDictionaries {
    ...
    public final Dictionary REGRESSION_EFFECTS = AtomicDictionary.builder()
            ...
            .item(AtomicDictionary.Item.builder().name(DET_F).description("forcasts of all deterministic effects (including pre-adjustment, but without trend polynomial effect). Untransformed").outputClass(TsData.class).type(Dictionary.EntryType.Parametric).build())
