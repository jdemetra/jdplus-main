...
public class LikelihoodDictionaries {
    ...
    public final AtomicDictionary LIKELIHOOD = AtomicDictionary.builder()
            ...
            .item(AtomicDictionary.Item.builder().name(AIC).description("akaike information criterion").outputClass(Double.class).build())
            .item(AtomicDictionary.Item.builder().name(BIC).description("bayesian information criterion").outputClass(Double.class).build())
            .item(AtomicDictionary.Item.builder().name(AICC).description("akaike information criterion corrected for sample size").outputClass(Double.class).build())
            .item(AtomicDictionary.Item.builder().name(BICC).description("bayesian information criterion corrected for sample size").outputClass(Double.class).build())
            .item(AtomicDictionary.Item.builder().name(BIC2).description("bic corrected for length").outputClass(Double.class).build())
            .item(AtomicDictionary.Item.builder().name(HQ).description("hannan–quinn information criterion").outputClass(Double.class).build())
