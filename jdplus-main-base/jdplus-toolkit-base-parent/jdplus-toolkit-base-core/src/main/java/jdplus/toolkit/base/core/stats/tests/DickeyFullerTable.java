...
public class DickeyFullerTable {
    ...
    public double probability3(int n, double q, DickeyFuller.DickeyFullerType type) {
    ...
    public double probability2(int n, double q, DickeyFuller.DickeyFullerType type) {
    ...
    public double probability(int n, double q, DickeyFuller.DickeyFullerType type, boolean ztest) {
