 ...
 * @author palatej
 */
public class HolidayImplTest {
    
    public HolidayImplTest() {
    }

    @Test
    public void testSignificantDomain() {
        FixedDay fd=new FixedDay(1,1, 1.0, ValidityPeriod.to(LocalDate.of(2000,1,1)));
