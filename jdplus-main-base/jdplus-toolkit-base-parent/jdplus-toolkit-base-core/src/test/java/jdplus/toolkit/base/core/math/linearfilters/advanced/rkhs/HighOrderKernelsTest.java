...
//        System.out.println("BiWeight");
        ...
        int m = 11;
        SymmetricFilter sf = LocalPolynomialFiltersFactory.of(m, 3, DiscreteKernel.biweight(m));
...
//        System.out.println("TriWeight");
        ...
        int m = 11;
        SymmetricFilter sf = LocalPolynomialFiltersFactory.of(m, 3, DiscreteKernel.triweight(m));
        DoubleUnaryOperator kernel = HighOrderKernels.kernel(K, 3);
        double step = 1.0 / (m + 1);
        Polynomial p = HighOrderKernels.p(K, 3);
        for (int i = 0; i <= m; ++i) {
...
//            System.out.println(p.times(Kernels.epanechnikovAsPolynomial()));
        ...
        int m = 11;
        SymmetricFilter sf = LocalPolynomialFiltersFactory.of(m, 3, DiscreteKernel.epanechnikov(m));
        DoubleUnaryOperator kernel = HighOrderKernels.kernel(K, 3);
        double step = 1.0 / (m + 1);
        Polynomial p = HighOrderKernels.p(K, 3);
        for (int i = 0; i <= m; ++i) {
...
//            System.out.println(kernel.applyAsDouble(step * i));
    ...
    public void testEpanechnikov5() {
        ...
        int R = 5;
        int m = 51;
        SymmetricFilter sf = LocalPolynomialFiltersFactory.of(m, R, DiscreteKernel.epanechnikov(m));
