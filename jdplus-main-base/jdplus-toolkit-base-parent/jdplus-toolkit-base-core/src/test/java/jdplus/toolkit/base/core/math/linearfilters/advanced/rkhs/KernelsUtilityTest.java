...
public class KernelsUtilityTest {
    ...
    public void testSymmetricFilter() {
        ...
        SymmetricFilter s2 = LocalPolynomialFiltersFactory.of(m, 3, DiscreteKernel.biweight(m));
        SymmetricFilter s3 = LocalPolynomialFiltersFactory.of(m, 3, DiscreteKernel.henderson(m));
