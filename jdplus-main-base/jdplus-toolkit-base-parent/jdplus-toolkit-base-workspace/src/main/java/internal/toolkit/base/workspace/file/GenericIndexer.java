...
import internal.toolkit.base.workspace.file.xml.XmlGenericWorkspace;
import internal.toolkit.base.workspace.file.xml.XmlGenericWorkspaceItem;
import internal.toolkit.base.workspace.JaxbUtil;
...
final class GenericIndexer implements Indexer {
    ...
    private static final Key SINGLE_CAL_GENERIC_KEY = new Key(WorkspaceFamily.UTIL_CAL, "Calendars");
