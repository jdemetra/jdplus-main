...
public class CsvArrayOutputFactory implements SaOutputFactory {
    ...
    private final CsvArrayOutputConfiguration configuration;
    private boolean enabled = true;

    public CsvArrayOutputFactory() {
        configuration = new CsvArrayOutputConfiguration();
    }

    public CsvArrayOutputFactory(CsvArrayOutputConfiguration configuration) {
...
//    }
    ...
    public CsvArrayOutput create() {
        return new CsvArrayOutput(configuration);
    }
}
